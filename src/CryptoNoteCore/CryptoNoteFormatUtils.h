...
bool constructTransaction(
  ...
  std::vector<uint8_t> extra, Transaction& transaction, uint64_t unlock_time,
...
bool get_block_longhash(Crypto::cn_context &context, const Block& b, Crypto::Hash& res, uint32_t &extrahashID);
